...
const PATH_REGULAR := "res://assets/fonts/NotoSansSC-Regular.otf"
const PATH_BOLD := "res://assets/fonts/NotoSansSC-Bold.otf"
const PATH_SERIF := "res://assets/fonts/NotoSerifSC-VF.ttf"
